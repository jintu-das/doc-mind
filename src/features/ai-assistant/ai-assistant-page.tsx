      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Ask questions across your entire document library with cited,
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <p className="text-base font-semibold">
                        {isNewChat ? "New conversation" : "Database comparison"}
                      </p>
              ...
              <div className="flex flex-col items-center justify-center gap-3 bg-card py-16 text-center ring-1 ring-foreground/10">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-sm text-xs text-muted-foreground">
                    Ask a question about your indexed documents, or try one of
                    ...
                    <Card>
                      <CardContent className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-3 text-sm text-foreground">
                          <p>
                            I found three primary databases mentioned across
                            your document library with distinct architectural
                            responsibilities:
                          </p>
